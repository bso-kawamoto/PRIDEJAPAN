...
$REPORTFLAG{$taikaicode}{1}{$area}{$kumi}{$setu} = $teamnum;	#
...
$sql_str2 = "SELECT * FROM $dbname WHERE contents = 34 and koukaiflag = 0 and taikaicode = '$taikaicode' and category = 1 and area = '$area2' and kumi = '$kumi2' and title = '$setu2' and text1 = '$num' ORDER BY serial ASC LIMIT 1";
...
if($teamserial == $teamnumtemp){$attention = "<br><span style='color:red;'></span>";}else{$attention = "<br><span style='color:red;'>相手が未報告です。</span>";}
}	#if



$reportflag = "<span style='color:red;font-weight:bold;'>未報告</span>";
if($REPORTFLAG{$taikaicode}{1}{$area2}{$kumi2}{$setu2} == $tss2){$reportflag = "<span style='color:green;font-weight:bold;'>報告済</span>";}

#if($teamserial == $tss1 ){	#自分だけ処理する
$schedulelist1 .=<<"END_HTML";
<tr>
<th align="center" scope="row"><a href="?code=gamescheduleform&taikaicode=$taikaicode&category=1&area=$area2&kumi=$kumi2&setu=$setu2&text1=$num&posi=0&aitess=$tss2"><img src="img/hensyuu.jpg" alt="編集" width="59" height="32" /></a></th>
...
my $teamnum = &paramsetsql('teamnum',$REFHASH1);
$REPORTFLAG{$taikaicode}{2}{$area}{$kumi}{$setu} = $teamnum;	#
...
$attention = "";
### 両チームの報告の突き合わせ
$sql_str2 = "SELECT * FROM $dbname WHERE contents = 34 and koukaiflag = 0 and taikaicode = '$taikaicode' and category = 2 and area = '$area' and kumi = '$kumi' and text1 = '$num'  ";
$rs2 = $dbh->prepare($sql_str2);
$rs2->execute();
$count2 = $rs2->rows;	# Hit件数を確保
#print "count2=$count2 $sql_str2<br>\n";
...
$REFHASH2 = $rs2->fetchrow_hashref;
$teamnumtemp = &paramsetsql('teamnum',$REFHASH2);
if($teamserial == $teamnumtemp){$attention = "";}else{$attention = "<br><span style='color:red;'>相手が未報告です。</span>";}
}	#if

#
$schedulelist2 .=<<"END_HTML";
<tr>
<th align="center" scope="row"><a href="?code=gamescheduleform&taikaicode=$taikaicode&category=2&area=$area&kumi=$kumi&setu=$gedan&text1=$num&posi=$posi&aitess=$aitess"><img src="img/hensyuu.jpg" alt="編集" width="59" height="32" /></a></th>
<th align="center" scope="row">$taikainame</th>
<th align="center" scope="row">$nichiji</th>
...
#重複チェック
$sql_str = "SELECT * FROM $dbname WHERE contents = 34 and taikaicode = '$taikaicode' and category = '$category' and area = '$area' and kumi = '$kumi' and title = '$setu' and text1 = '$text1' and linkadrtitle = '$posi' and linkadr = '$loginuser' and  teamnum = '$aitess' ";
$rs = $dbh->prepare($sql_str);
$rs->execute();
$count = $rs->rows;	# Hit件数を確保
if($count != 0){
...
$resultlist .=<<"END_HTML";
<tr>
<td align="center" ><a $editflag href="?code=gameresultform&taikaicode=$taikaicode&category=1&area=$area&kumi=$kumi&setu=$setu&num=$num&aitess=$tss2"><img src="img/hensyuu.jpg" alt="編集" width="59" height="32" /></a>
</td>
<td align="center" >$taikainame</td>
<td align="center" >$nichijireport&nbsp;</td>
...
#if($posi == 1 ){	#自分が左
#自分の試合結果報告をGET
$sql_str5 = "SELECT * FROM $dbname WHERE contents = 35 and koukaiflag = 0 and taikaicode = '$taikaicode' and category = 2 and area = '$area' and kumi = '$kumi' and title = '$gedan' and linkadr = '$loginuser' and teamnum = $aitess ";
...
#$aiteteam = "<a href='?code=mypage_team&ses=$aitesession'>$aiteteam</a>";
#print "()=($tempname,$aitesession)<br>\n";
$sql_str2 = "SELECT * FROM $dbname WHERE contents = 35 and koukaiflag = 0 and taikaicode = '$taikaicode' and category = 2 and area = '$area' and kumi = '$kumi' and title = '$gedan' and teamnum = '$tss' ";
$rs2 = $dbh->prepare($sql_str2);
$rs2->execute();
$count2 = $rs2->rows;	# Hit件数を確保
...
#if($tsstemp ne ""){	#
#試合日と開催地をGET
$sql_str4 = "SELECT * FROM $dbname WHERE contents = 34 and koukaiflag = 0 and taikaicode = $taikaicode and category = 2 and area = $area and kumi = $kumi and text1 = $num ORDER BY serial ASC LIMIT 1";
$rs4 = $dbh->prepare($sql_str4);
$rs4->execute();
&sqlcheck($sql_str4);
$count4 = $rs4->rows;	# Hit件数を確保
...
<tr>
<td align="center" ><a $editflag href="?code=gameresultform&taikaicode=$taikaicode&category=2&area=$area&kumi=$kumi&setu=$gedan&num=$num&aitess=$aitess"><img src="img/hensyuu.jpg" alt="編集" width="59" height="32" /></a>
</td>
<td align="center" >$taikainame</td>
<td align="center" >$nichijireport&nbsp;</td>
...
($teamname,$tss) = &taikaiteamname_get2($loginuser);
#「試合報告書」をGET
$sql_str1 = "SELECT * FROM $dbname WHERE contents = 34 and koukaiflag = 0  and taikaicode = '$taikaicode' and category = '$category' and area = '$area' and kumi = '$kumi' and title = '$setu' and text1 = '$num' ";
$rs1 = $dbh->prepare($sql_str1);
$rs1->execute();
$count1 = $rs1->rows;	# Hit件数を確保
$REFHASH1 = $rs1->fetchrow_hashref;
...
<tr>
<td align="center" bgcolor="#F2F2F2"><font class="type1">名称</font></td>
<td bgcolor="#ffffff">地区名：$areaname<br>　組名：$kuminame</td>
</tr>
<tr>
<td align="center" bgcolor="#F2F2F2"><font class="type1">対戦チーム</font></td>
<td bgcolor="#ffffff">$aiteteam</td>
...
$caption = "";
foreach $i(0..2){
if($paramhash{"file$i"} ne ""){$file = &fileup("file$i",$contents,"system/");}else{$file = $paramhash{"filename$i"};}
...
#重複チェック
$sql_str = "SELECT * FROM $dbname WHERE contents = 35 and linkadr = '$loginuser' and taikaicode = '$taikaicode' and category = '$category' and area = '$area' and kumi = '$kumi' and title = '$setu' and text1 = '$num' and linkadrtitle = '$posi'  ";
#and linkadr = '$loginuser' and  teamnum = '$aitess'
$rs = $dbh->prepare($sql_str);
$rs->execute();
$count = $rs->rows;	# Hit件数を確保
if($count != 0){
...
<div class="teamr">
<h2 class="subti" style="background-image:url(img/te4.jpg)">チームメンバー紹介</h2>
<ul>
$memberlist
</ul>
</div>
...
#報告データをGET
$sql_str2 = "SELECT * FROM $dbname WHERE contents = 34 and koukaiflag = 0 and taikaicode = $taikaicode and category = 2 and area = $area and kumi = $x and text1 = $y and (teamnum = $tss1 or teamnum = $tss2) ORDER BY serial ASC ";
$rs2 = $dbh->prepare($sql_str2);
$rs2->execute();
$count2 = $rs2->rows;	# Hit件数を確保
#print "count2=$count2 $sql_str2<br>";
...
#２番目以降
#短い記事を用意
$body = &paramsetsql('body');	#素のテキストデータ
if(length($body) > 10){			#○○文字以上あれば
$body1 = &crlfreset2(substr($body,0,10));	#最初の○○文字
$body2 = &crlfreset2(substr($body,10));		#最初の○○文字以降全部
$body =<<"END_HTML";
$body1<span id="stag$ss" style="color:orange;text-decoration:underline;" onClick="tagopen($ss)">...続きはこちら</span><span id="tag$ss" style="display:none;">$body2<span style="color:orange;text-decoration:underline;" onClick="tagclose($ss)"><br>≪閉じる</span>
</span>
END_HTML
}else{
$body = &paramsetsql2('body');	#
...
$sql_str = "SELECT * FROM entrylist WHERE taikaicode = $taikaicode and category = $category and teamnum = $teamnum and teamsession = '$loginuser' and pref = '$pref' and (pr = '$pr' or pr IS NULL) and weeklist = '$weeklist'  ";
$rs = $dbh->prepare($sql_str);
$rs->execute();
$count = $rs->rows;	# Hit件数を確保
if($count != 0){
...
<tr>
<th align='center' scope='row'>$k</th>
...
END_HTML
$mailbody = Unicode::Japanese->new($mailbody,'utf8')->jis;		#JISとして処理
open(MAIL, "| /usr/sbin/sendmail -t ") or die "sendmail open error.";
print MAIL "$mailheader\n$mailbody";	#送信
close MAIL;
