		...
		<div class="inner">
			...
			・「自作スキン」はHTML、CSSを編集してメールフォームを使用サイトにあわせて自由に設定できます。<br />
				<div style="text-align:left;">
					...
					<select name="design_mode" onchange="ChangeDesignMode();">
	...
	<div id="default_design" {$set_default_design}>
		...
		<div class="inner">
			...
			<tr>
				<th scope="row">横幅</th>
				<td>
					<div class="explain_item">メールフォームの横幅を設定します</div>
					<div class="setting_item"><input type="text" name="form_width" value="{$basic_formwidth}" style="ime-mode: inactive" maxlength="4" onchange="ClosePreview();" />px</div>
				</td>
			</tr>
			</table>
		</div>
		...
		<div class="inner">
			...
			<tr>
				...
				<td>
					...
					<div class="explain_item">タイトルの文字色を設定します</div>
					<div class="setting_item">設定色：#<input name="color_title" id="color_title" type="text" value="{$color_title}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_title');" /></div>
					<div class="current_color">
						...
						(#<span id="code_color_title">{$color_title}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_title', 'ff6600' );setColorPanel('color_title');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_explain" id="color_explain" type="text" value="{$color_explain}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_explain');" /></div>
					<div class="current_color">
						<div id="panel_color_explain" class="current_setting" style="background-color : #{$color_explain} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_explain">{$color_explain}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_explain', '000000' );setColorPanel('color_explain');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
                    	<dt>色見本：</dt>
                        <dd>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_background" id="color_background" type="text" value="{$color_background}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_background');" /></div>
					<div class="current_color">
						<div id="panel_color_background" class="current_setting" style="background-color : #{$color_background} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_background">{$color_background}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_background', 'ffffff' );setColorPanel('color_background');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
                    	<dt>色見本：</dt>
                        <dd>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_line" id="color_line" type="text" value="{$color_line}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_line');" /></div>
					<div class="current_color">
						<div id="panel_color_line" class="current_setting" style="background-color : #{$color_line} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_line">{$color_line}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_line', 'b3b3b3' );setColorPanel('color_line');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
                    	<dt>色見本：</dt>
                        <dd>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_menubg" id="color_menubg" type="text" value="{$color_menubg}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_menubg');" /></div>
					<div class="current_color">
						<div id="panel_color_menubg" class="current_setting" style="background-color : #{$color_menubg} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_menubg">{$color_menubg}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_menubg', '444444' );setColorPanel('color_menubg');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
						<dt>色見本：</dt>
						<dd>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_menufont" id="color_menufont" type="text" value="{$color_menufont}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_menufont');" /></div>
					<div class="current_color">
						<div id="panel_color_menufont" class="current_setting" style="background-color : #{$color_menufont} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_menufont">{$color_menufont}</span>) <div class="set_default"><a href="javascript:void(0)" onclick="setDesignColor( 'color_menufont', 'ffffff' );setColorPanel('color_menufont');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
                    	<dt>色見本：</dt>
                        <dd>
			...
			<tr>
				...
				<td>
					...
					<div class="setting_item">設定色：#<input name="color_error" id="color_error" type="text" value="{$color_error}" maxlength="6" style="ime-mode: inactive" onchange="ClosePreview();setColorPanel('color_error');" /></div>
					<div class="current_color">
						<div id="panel_color_error" class="current_setting" style="background-color : #{$color_error} ;">現在の設定カラー</div><!-- current_setting -->
						(#<span id="code_color_error">{$color_error}</span>) <div class="set_default"><a href="javascript:void(0)"  onclick="setDesignColor( 'color_error', 'ff3333' );setColorPanel('color_error');ClosePreview();return false;">初期設定値に戻す</a></div>
					</div>
					<dl class="select_item">
                    	<dt>色見本：</dt>
                        <dd>
			...
			<tr>
				<td colspan="2" style="text-align : right ;">
					<input type="button" value="設定の初期化" onclick="allDesignReset();" />
				</td>
			</tr>
			</table>
		...
		<div class="button_box">
			<strong>・</strong>
			「サイズの設定」、「配色の設定」または「メッセージの設定」の変更を行う場合は、「<strong>設定を保存する(確認)</strong>」ボタンを押してください。<br />
			<br />
		...
		<div class="inner">
			...
			<div id="table_template_input" {$template_table_0}>
				...
				<div class="input_textarea">
					<textarea name="template_input" cols="92" rows="30" style="ime-mode: active;width:100%;" onchange="ClosePreview();BoldChangeTemplate( 'input', true );">{$template_input}</textarea>
			...
			<div id="table_template_conf" {$template_table_1}>
				...
				<div class="input_textarea">
					<textarea name="template_conf" cols="92" rows="30" style="ime-mode: active;width:100%;" onchange="ClosePreview();BoldChangeTemplate( 'conf', true );">{$template_conf}</textarea>
			...
			<div id="table_template_exit" {$template_table_2}>
				...
				<div class="input_textarea">
					<textarea name="template_exit" cols="92" rows="30" style="ime-mode: active;width:100%;" onchange="ClosePreview();BoldChangeTemplate( 'exit', true );">{$template_exit}</textarea>
			...
			<div id="table_template_css" {$template_table_3}>
				<div class="input_textarea">
					<textarea name="template_css" cols="92" rows="30" style="ime-mode: active;width:100%;" onchange="ClosePreview();BoldChangeTemplate( 'css', true );">{$template_css}</textarea>
